...
const (
	VPSProxyService_GetHttpProxy_FullMethodName    = "/vpsproxy.VPSProxyService/GetHttpProxy"
	VPSProxyService_UpdateHttpProxy_FullMethodName = "/vpsproxy.VPSProxyService/UpdateHttpProxy"
	VPSProxyService_Shutdown_FullMethodName        = "/vpsproxy.VPSProxyService/Shutdown"
)
...
type VPSProxyServiceClient interface {
	GetHttpProxy(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetHttpProxyResponse, error)
	UpdateHttpProxy(ctx context.Context, in *UpdateHttpProxyReq, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *vPSProxyServiceClient) GetHttpProxy(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetHttpProxyResponse, error) {
	out := new(GetHttpProxyResponse)
	err := c.cc.Invoke(ctx, VPSProxyService_GetHttpProxy_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vPSProxyServiceClient) UpdateHttpProxy(ctx context.Context, in *UpdateHttpProxyReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, VPSProxyService_UpdateHttpProxy_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vPSProxyServiceClient) Shutdown(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, VPSProxyService_Shutdown_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type VPSProxyServiceServer interface {
	GetHttpProxy(context.Context, *emptypb.Empty) (*GetHttpProxyResponse, error)
	UpdateHttpProxy(context.Context, *UpdateHttpProxyReq) (*emptypb.Empty, error)
...
func (UnimplementedVPSProxyServiceServer) GetHttpProxy(context.Context, *emptypb.Empty) (*GetHttpProxyResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetHttpProxy not implemented")
}
func (UnimplementedVPSProxyServiceServer) UpdateHttpProxy(context.Context, *UpdateHttpProxyReq) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateHttpProxy not implemented")
}
func (UnimplementedVPSProxyServiceServer) Shutdown(context.Context, *emptypb.Empty) (*emptypb.Empty, error) {
...
func _VPSProxyService_GetHttpProxy_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: VPSProxyService_GetHttpProxy_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VPSProxyServiceServer).GetHttpProxy(ctx, req.(*emptypb.Empty))
	}
...
func _VPSProxyService_UpdateHttpProxy_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: VPSProxyService_UpdateHttpProxy_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _VPSProxyService_Shutdown_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: VPSProxyService_Shutdown_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VPSProxyServiceServer).Shutdown(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
